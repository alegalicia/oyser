...
<head>
	...
	<title>Obras y Servicios - Argentina Córdoba Capital</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="OYSER - Obras y Servicios" />
	<meta name="keywords" content="OYSER - Obras y Servicios" />
	<meta name="author" content="OYSER" />
...
<body>
	...
	<div class="fb-customerchat" attribution="install_email" page_id="102694051822248" theme_color="#0A7CFF" logged_in_greeting="Hola en que te puedo ayudar?" logged_out_greeting="Hola en que te puedo ayudar?">
	</div>
		...
		<div class="fluid-container">
			<nav class="navbar navbar-default">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.php">Twist</a>
				</div>
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="#" data-nav-section="explore"><span>Nuestros Trabajos</span></a></li>
						<!-- <li><a href="#" data-nav-section="testimony"><span>Testimony</span></a></li> -->
						<!-- <li><a href="#" data-nav-section="Precios"><span>Pricing</span></a></li> -->
						<li><a href="#" data-nav-section="testimony"><span>Nuestros Clientes</span></a></li>
				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center">
							<h1 class="to-animate">Obras y Servicios <span>OYSER</span></h1>
							<h2 class="to-animate">Claudio Hérnan Peralta
								<br><a href="https://www.oyser.ar" target="_blank" title="Obras y Servicios - Argentina Cordoba" class="fh5co-link">https://www.oyser.ar</a>
							</h2>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 section-heading text-center">
						<h2 class="to-animate"><span>Obras y Servicios</span></h2>
						<div class="row">
							<div class="col-md-8 col-md-offset-2 subtext">
								<h3 class="to-animate">En todo tipo de obas realizamos, casas, departamientso y edeficios.</h3>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-3 text-center">
						<div class="box-services">
							...
							<div class="fh5co-post to-animate">
								...
								<p>Instalaciones eléctricas con personal certificado.</p>
							</div>
						</div>

						<div class="box-services">
							<div class="icon to-animate">
								<span><i class="fas fa-sink"></i></i></span>
							</div>
							<div class="fh5co-post to-animate">
								<h3>Plomería</h3>
								<p>Obras desde casas hasta edificios, personal matriculado. </p>
							</div>
						</div>
					</div>
					<div class="col-md-3 text-center">
						<div class="box-services">
							...
							<div class="fh5co-post to-animate">
								<h3>Cloacas</h3>
								<p>Cañerias de cloacas, aguas grices, desobtrucciones y mantenciones preventivas. </p>
							</div>
						</div>
						...
						<div class="box-services">
							...
							<div class="fh5co-post to-animate">
								<h3>Pintura</h3>
								<p>Pintamos casas, departamentos y edificios.</p>
							</div>
						</div>
					...
					<div class="col-md-3 text-center">
						...
						<div class="box-services">
							...
							<div class="fh5co-post to-animate">
								<h3>Proveedor de Mano de Obra</h3>
								<p>Proveedor de mano de obra para la construcción de casas y edificios, con y sin dirección técnica.</p>
							</div>
						</div>
					</div>
					<div class="col-md-3 text-center">
						<div class="box-services">
							...
							<div class="fh5co-post to-animate">
								<h3>24/7</h3>
								<p>Atendemos emergencias 24 * 7.</p>
							</div>
						</div>
	...
	<section id="fh5co-explore" data-section="explore">
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate"><span>Nuestros trabajos</span></h2>
					<div class="row">
	...
	<section id="fh5co-testimony" class="fh5co-bg-color" data-section="testimony">
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate"><span>Nuestros Clientes</span></h2>
					<div class="row">
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 to-animate">
					<h3 class="section-title">Obras y Servicios</h3>
				</div>

				<div class="col-md-4 to-animate">
					<h3 class="section-title">Direccion</h3>
					<ul class="contact-info">
						<li><i class="icon-map-marker"></i>Argentina - Córdoba - Capital</li>
						<li><i class="icon-phone"></i>+54 9 3513 33-2601</li>
						<li><i class="icon-envelope"></i><a href="#">consultas@oyser.ar</a></li>
						<li><i class="icon-globe2"></i><a href="#">www.oyser.ar</a></li>
					</ul>
					<h3 class="section-title">Contacto Argetina</h3>
					<ul class="social-media">
						<li><a href="#" class="google"><i class="fab fa-google"></i></a></li>
						<li><a href="https://www.facebook.com/Oyser-102694051822248" class="facebook"><i class="fab fa-facebook"></i></a></li>
						<li><a href="https://api.whatsapp.com/send?phone=5493513332601&text=Hola!%20Quiero%20rconsultar!!!" class="whatsapp"><i class="fab fa-whatsapp"></i></a></li>
					</ul>
				</div>
				<div class="col-md-4 to-animate">
					<h3 class="section-title">Consulta en linea</h3>
					<form class="contact-form">
						...
						<div class="form-group">
							<input type="submit" id="btn-submit" class="btn btn-send-message btn-md" value="Enviar Consulta">
						</div>
					</form>
				</div>
			</div>
